...
const TournamentMatchStats = sequelize.define("TournamentMatchStats", {
  id: { type: DataTypes.INTEGER, autoIncrement: true, primaryKey: true },
  tournamentMatchId: { type: DataTypes.INTEGER, allowNull: false, unique: true },
...
module.exports = TournamentMatchStats;
